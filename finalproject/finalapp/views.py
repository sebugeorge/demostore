...
def register(request):
    if request.method == 'POST':
        ...
        if not username or not password:  # Check if username or password is None or empty
...
class Form(forms.ModelForm):
    ...
    class Meta:
        model = FormModel
        fields = ['name', 'dob', 'age', 'gender', 'phone', 'email', 'address', 'department', 'topic', 'purpose', 'materials']
